The following is a list of assets used in the hostcoin source and their proper attribution.
...
* License: MIT
* Site: [https://hostcointalk.org/index.php?topic=15276.0](https://hostcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original hostcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/hostcoin.icns, src/qt/res/src/hostcoin.svg,
	src/qt/res/src/hostcoin.ico, src/qt/res/src/hostcoin.png,
	src/qt/res/src/hostcoin_testnet.png, docs/hostcoin_logo_doxygen.png,
