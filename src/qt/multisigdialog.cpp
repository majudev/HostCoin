...
void MultiSigDialog::createRawTransaction()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::XHC, rcp.amount), Qt::escape(rcp.label), rcp.address));
#else
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::XHC, rcp.amount), rcp.label.toHtmlEscaped(), rcp.address));
#endif
    }
...
*/
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnit(BitcoinUnits::XHC, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void MultiSigDialog::importDraft()
{
    QString filename = GUIUtil::getLoadFileName(
            this,
            tr("Load Hostcoin Transaction"), QString(),
            tr("Hostcoin transaction file (*.ftc)"));
...
void MultiSigDialog::exportDraft()
{
    ...
    if ( isTxCreate )
    {
        QString filename = GUIUtil::getSaveFileName(
                this,
                tr("Save Hostcoin Transaction"), QString(),
                tr("Hostcoin transaction file (*.ftc)"), NULL);
