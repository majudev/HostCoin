...
{   
    ...
    //{"result":"success","timestamp":1432562645,"BTC_DASH":["81.2366199952",1],"DASH_BTC":["0.0116620098",-1],"BTC_DOGE":["1633333.333333333",0],"DOGE_BTC":["0.0000005782",0],"BTC_XHC":["50943.9640074796",0],"XHC_BTC":["0.0000164383",0],"BTC_LTC":["128.6659808144",-1],"LTC_BTC":["0.0073686355",1],"BTC_NMC":["623.9861305917",1],"NMC_BTC":["0.0013302033",-1],"BTC_PPC":["696.1033450117",-1],"PPC_BTC":["0.0013102915",1],"DASH_DOGE":["19047.9493465333",0],"DOGE_DASH":["0.000046971",0],"DASH_XHC":["594.1090077099",0],"XHC_DASH":["0.0013353946",0],"DASH_LTC":["1.5005039297",-1],"LTC_DASH":["0.5986030454",1],"DASH_NMC":["7.2769323725",1],"NMC_DASH":["0.1080612229",-1],"DASH_PPC":["8.1179640341",-1],"PPC_DASH":["0.1064436502",1],"DOGE_XHC":["0.0294558",0],"XHC_DOGE":["26.8492772333",0],"DOGE_LTC":["0.0000743947",-1],"LTC_DOGE":["12035.4380519333",1],"DOGE_NMC":["0.0003607888",1],"NMC_DOGE":["2172.6654488",-1],"DOGE_PPC":["0.000402487",-1],"PPC_DOGE":["2140.1427343333",1],"XHC_LTC":["0.0021150542",-1],"LTC_XHC":["375.3875038359",1],"XHC_NMC":["0.0102572918",-1],"NMC_XHC":["67.7658308718",1],"XHC_PPC":["0.0114427786",-1],"PPC_XHC":["66.751441487",1],"LTC_NMC":["4.5979263796",1],"NMC_LTC":["0.1711519169",-1],"LTC_PPC":["5.129331849",1],"PPC_LTC":["0.1685899371",-1],"NMC_PPC":["0.9259589917",-1],"PPC_NMC":["0.8176037043",1]}
    ...
    if(json.isObject())  
    {
				...
				if(obj.contains("XHC_BTC"))
				{
					QJsonValue name_value = obj.take("XHC_BTC");
					listModel->setItem(0,0,new QStandardItem("XHC_BTC"));
					listModel->setItem(0,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("XHC_DOGE"))
				{
					QJsonValue name_value = obj.take("XHC_DOGE");
					listModel->setItem(1,0,new QStandardItem("XHC_DOGE"));
					listModel->setItem(1,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("XHC_LTC"))
				{
					QJsonValue name_value = obj.take("XHC_LTC");
					listModel->setItem(2,0,new QStandardItem("XHC_LTC"));
					listModel->setItem(2,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("XHC_PPC"))
				{
					QJsonValue name_value = obj.take("XHC_PPC");
					listModel->setItem(3,0,new QStandardItem("XHC_PPC"));
					listModel->setItem(3,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("XHC_NMC"))
				{
					QJsonValue name_value = obj.take("XHC_NMC");
					listModel->setItem(4,0,new QStandardItem("XHC_NMC"));
					listModel->setItem(4,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("XHC_DASH"))
				{
					QJsonValue name_value = obj.take("XHC_DASH");
					listModel->setItem(5,0,new QStandardItem("XHC_DASH"));
					listModel->setItem(5,1,new QStandardItem(name_value.toArray()[0].toString()));
				}
				
				
				if(obj.contains("BTC_XHC"))
				{
					QJsonValue name_value = obj.take("BTC_XHC");
					listModel->setItem(0,2,new QStandardItem("BTC_XHC"));
					listModel->setItem(0,3,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("DOGE_XHC"))
				{
					QJsonValue name_value = obj.take("DOGE_XHC");
					listModel->setItem(1,2,new QStandardItem("DOGE_XHC"));
					listModel->setItem(1,3,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("LTC_XHC"))
				{
					QJsonValue name_value = obj.take("LTC_XHC");
					listModel->setItem(2,2,new QStandardItem("LTC_XHC"));
					listModel->setItem(2,3,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("PPC_XHC"))
				{
					QJsonValue name_value = obj.take("PPC_XHC");
					listModel->setItem(3,2,new QStandardItem("PPC_XHC"));
					listModel->setItem(3,3,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("NMC_XHC"))
				{
					QJsonValue name_value = obj.take("NMC_XHC");
					listModel->setItem(4,2,new QStandardItem("NMC_XHC"));
					listModel->setItem(4,3,new QStandardItem(name_value.toArray()[0].toString()));
				}
				if(obj.contains("DASH_XHC"))
				{
					QJsonValue name_value = obj.take("DASH_XHC");
					listModel->setItem(5,2,new QStandardItem("DASH_XHC"));
