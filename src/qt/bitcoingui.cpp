...
// Copyright (c) 2013-2015 The Hostcoin developers
    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hostcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hostcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hostcoin: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Hostcoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Hostcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hostcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hostcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hostcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hostcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a hostcoin: URI or payment request"));
    
    bitmessageAction = new QAction(QIcon(":/icons/bitmessage"), tr("B&itmessage..."), this);
    bitmessageAction->setStatusTip(tr("Start Bitmessage from hostcoin wallet"));
    ...
    shapeshiftAction->setStatusTip(tr("Exchange other coins whit your hostcoin on Shapeshift"));
    ...
    coinnectorAction->setStatusTip(tr("Exchange other coins whit your hostcoin on Coinnector"));
    coinnectorAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_9));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Hostcoin Core help message to get a list with possible Hostcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Hostcoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Hostcoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hostcoin network", "", count));
}
...
{
    QString strTitle = tr("Hostcoin"); // default title
