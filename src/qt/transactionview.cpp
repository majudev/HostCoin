...
void TransactionView::showTotal()
{
    ...
    totalWidget->setText(tr("Date:")+dateWidget->currentText()+" "+tr("Type:")+typeWidget->currentText()+" "+tr("Total:")+QObject::tr("%1").arg(fTotal)+" XHC");
}
...
void TransactionView::sendMess()
{
    ...
    if(!selection.isEmpty())
    {
    		...
    		QString txDesc="Sent "+amount+" XHC to you, TransactionID="+txid;
